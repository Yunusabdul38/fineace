  ...
  return (
    <>
      ...
      >
        ...
        <ul
          className={`flex sm:flex-row sm:absolute lg:relative sm:top-20 lg:top-0 sm:left-0 py-4 lg:py-0 sm:bg-white lg:bg-inherit sm:justify-around sm:w-full lg:w-fit ${!menu ? "hidden" : "flex-col"
        ...
        <ul
          className={`${!menu ? "min-[360px]:absolute sm:relative min-[360px]:right-14 sm:right-0 max-[447px]:hidden" : ""
            }  flex sm:flex-row justify-between sm:items-center gap-2 md:gap-5 w-fit`}
        >
          {!address && <>
            <button className="hover:bg-orangePrimary bg-white hover:text-white border-2 text-orangeText border-orangeText hover:border-transparent transition-all duration-500 ease-in-out rounded-md px-2 py-1 sm:px-4 sm:py-2 capitalize font-LexendDeca font-normal w-fit">
              <span className="block absolute w-full h-full left-0 top-0 opacity-0"><ConnectButton chainStatus="icon" /></span>
