...
export default function Home() {
  return (
    <div className="">
      ...
      <section className="font-Urbanist text-[#1A1A1A] p-10 mt-20 relative" id="about">
        ...
        <div className="flex flex-col gap-5 sm:flex-row mb-10 mx-auto justify-center">
            <div className="sm:w-1/2 md:w-2/5">
                ...
                <h1 className="text-4xl md:text-5xl font-semibold">We are the team <br/> of enthusiasts</h1>
            </div>
            <div className="sm:w-1/2 md:w-2/5">
    ...
    <div className="bg-white max-w-xs flex flex-col justify-center items-center p-5 rounded-sm gap-2 mx-auto">
      ...
      <section className="mt-20 flex justify-between flex-wrap px-10">
        <Card/>
        <Card/>
        <Card/>
        <Card/>
